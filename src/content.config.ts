...
const comics = defineCollection({
  ...
  schema: z.object({
    ...
    summary: z.string(),
    absurdity: z.string(),
    category: z.enum(['AI', 'Technology', 'Politics', 'Business', 'Work', 'Internet', 'Life', 'Science', 'Humanity']),
    tags: z.array(z.string()),
    comicImage: z.string(),
    comicImageAlt: z.string(),
    comicLayout: z.enum(['standard', 'panoramic']).default('standard'),
    comicPanels: z.array(z.string()).min(3).max(4),
    comicVariants: z.array(z.object({
      title: z.string(),
      image: z.string(),
      imageAlt: z.string(),
      panels: z.array(z.string()).min(3).max(4),
    })).default([]),
    sourceName: z.string(),
    sourceUrl: z.url(),
